...
class Case(models.Model):
    ...
    registerer = models.ForeignKey('Staff', on_delete=models.CASCADE, null=False, related_name="staff_registerer")
...
class CaseInvestigator(models.Model):
    ...
    investigator = models.ForeignKey('Staff', on_delete=models.CASCADE, null=False, related_name="cas_investigator")
