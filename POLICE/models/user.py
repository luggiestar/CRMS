...
class Staff(models.Model):
    ...
    title = models.ForeignKey(Title, on_delete=models.CASCADE, null=False, related_name="staff_position")
    station = models.ForeignKey('Station', on_delete=models.CASCADE, null=False, related_name="staff_station")
    registered_on = models.DateTimeField(auto_now_add=True)
